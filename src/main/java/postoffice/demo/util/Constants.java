...
public class Constants {
    ...
    public static final String MALL_ACCESS_TOKEN = "MALL-ACCESS-TOKEN";

    public static final String VALUE_MALL_ACCESS_TOKEN = "ZNS6y9Gz38sutTq4EoLAZGDTiGKZNM4rx12Ng51JYk39qZRSuACeJWcAY75pT79K";
}
